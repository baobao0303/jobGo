...
-- AddForeignKey
ALTER TABLE "CandidateLanguage" ADD CONSTRAINT "CandidateLanguage_candidateProfileId_fkey" FOREIGN KEY ("candidateProfileId") REFERENCES "CadidateProfile"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
